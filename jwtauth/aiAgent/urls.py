...
from aiAgent.views import AgentAIViewSet, TokenUsageAnalyticsView, dashboard_chat_view, RankingAPIView, UserAvailableModelsView, AgentMetricsAPIView, DeleteRankingDataAPIView, UpdateCacheScopeAPIView
...
urlpatterns = [
    ...
    path('ranking/delete/<str:agent_id>/<str:msg_hash>/', DeleteRankingDataAPIView.as_view(), name='delete-ranking-data'),
