(function() {
    ...
    var DEFAULT_ICON = "https://newsmartagent.com/newsmartagent_ai_logo.jpeg";
    ...
    function initWidget() {
        ...
        var radius     = Math.round(size * 0.28) + 'px';
        ...
        var css = [
            ...
            '#nsa-bubble{width:' + size + 'px;height:' + size + 'px;border-radius:' + radius + ';background:' + color + ';box-shadow:0 8px 30px rgba(0,0,0,.2);display:flex;align-items:center;justify-content:center;cursor:pointer;overflow:hidden;transition:transform .3s cubic-bezier(.175,.885,.32,1.275),box-shadow .3s;}',
