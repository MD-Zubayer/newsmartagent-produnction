...
const translations = {
  en: {
    ...
    heroDesc: "New Smart Agent brings an all-in-one platform. Connect your Facebook, WhatsApp & YouTube and save time with our smart AI tools.",
    ...
    aboutP1: "New Smart Agent is a complete smart platform that helps make your business and personal life easier through Facebook, WhatsApp and Messenger.",
  ...
  bn: {
    badge: "বাংলাদেশের সবচেয়ে বিশ্বস্ত এআই অটোমেশন",
    heroTitle1: "আপনার",
    heroTitle2: "সোশ্যাল মিডিয়া",
    heroTitle3: "অটোমেট করুন ও দ্রুত বাড়ুন",
    heroDesc: "New Smart Agent নিয়ে এসেছে একটি অল-ইন-ওয়ান প্লাটফর্ম। আপনার ফেসবুক, হোয়াটসঅ্যাপ ও ইউটিউব সংযোগ করুন এবং সময় বাঁচান আমাদের স্মার্ট এআই টুলস দিয়ে।",
    getStarted: "বিনামূল্যে শুরু করুন",
    learnMore: "আরও জানুন",
    noCard: "কার্ড লাগবে না",
    secured: "SSL সুরক্ষিত",
    featuresBadge: "প্ল্যাটফর্মের মূল ফিচারসমূহ",
    featuresTitle1: "স্মার্ট এআই দিয়ে",
    featuresTitle2: "বিজনেস অটোমেশন",
    featuresTitle3: "এখন সহজ",
    ...
    servicesBadge: "আপনার প্রয়োজনীয় সবকিছু",
    servicesTitle1: "স্মার্ট ব্যবসার জন্য",
    servicesTitle2: "সেরা সলিউশন",
    ...
    ctaTitle1: "আপনার ব্যবসার জন্য কি",
    ctaTitle2: "কাস্টম অটোমেশন প্রয়োজন?",
    ...
    aboutBadge: "আমরা কারা",
    aboutTitle1: "আমাদের সম্পর্কে",
    aboutTitle2: "জেনে নিন",
    aboutP1: "New Smart Agent একটি সম্পূর্ণ স্মার্ট প্ল্যাটফর্ম, যা Facebook, WhatsApp এবং Messenger-এর মাধ্যমে আপনার ব্যবসায়িক ও ব্যক্তিগত জীবন আরও সহজ করতে সাহায্য করে।",
    ...
    contactTitle1: "আমাদের সাথে",
    contactTitle2: "কথা বলুন",
    contactItems: [
